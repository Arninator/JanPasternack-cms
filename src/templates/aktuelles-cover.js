...
export const AktuellesCoverTemplate = ({
  content,
  contentComponent,
  info,
  title,
...
AktuellesCoverTemplate.propTypes = {
...
const AktuellesCover  = ({ data }) => {
  const { markdownRemark: post } = data;

  return (
    <Layout>
      <AktuellesCoverTemplate
        content={post.html}
...
export default AktuellesCover ;

export const pageQuery = graphql`
  query AktuellesCoverByID($id: String!) {
