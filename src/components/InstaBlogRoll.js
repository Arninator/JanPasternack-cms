...
class InstaBlogRollTemplate extends React.Component {
  render() {
...
export default function InstaBlogRoll() {

  // console.log("aktuellesBlogroll")
  return (
    <StaticQuery
      query={graphql`
        query InstaBlogRollQuery {
          allMarkdownRemark(
      ...
      `}
      render={(data, count) => <InstaBlogRollTemplate data={data} count={count} />}
    />
  );
}
